...
export const StaggeredMenu = ({
  ...
  logoMobileUrl = "/src/assets/logos/reactbits-gh-white.svg",
  menuButtonColor = "#fff",
  ...
  return (
    <div
      className={`font-srcpro sm-scope z-40 ${isFixed ? "fixed top-0 left-0 w-screen h-screen overflow-hidden" : "w-full h-full"}`}
    >
      <div
        className={
          (className ? className + " " : "") +
      ...
      >
        ...
        <header
          className=" absolute top-0 left-0 w-full flex items-center justify-between p-[2em] px-8 xl:px-20 bg-transparent pointer-events-none z-20"
        ...
        >
          ...
          <button
            ref={toggleBtnRef}
            className="sm-toggle relative inline-flex items-center gap-[0.3rem] bg-transparent border-0 cursor-pointer text-[#e9e9ef] font-medium leading-none overflow-visible pointer-events-auto uppercase"
